...
instance Yesod App where
    ...
    defaultLayout widget = do
        ...
        pc <- widgetToPageContent $ do
            ...
            addScriptRemote "/static/jsexe/all.js"
...
instance YesodAuth App where
    ...
    authenticate creds = runDB $ do
        ...
        case x of
            ...
            Nothing -> Authenticated <$> insert UserDb
                { userDbIdent = credsIdent creds
                , userDbPassword = Nothing
                }
